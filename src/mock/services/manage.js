...
Mock.mock(/\/customer/, 'get', customerList)

const followList = (options) => {
  const parameters = getQueryParameters(options)
  const result = []
  const pageNo = parseInt(parameters.pageNo)
  const pageSize = parseInt(parameters.pageSize)
...
Mock.mock(/\/follow/, 'get', followList)
...
Mock.mock(/\/department/, 'get', departmentList)
// ----------------------------分割---------------------------------
